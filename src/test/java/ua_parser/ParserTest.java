...
public class ParserTest {
    ...
    public void initParser() throws Exception {
        URL url = this.getClass().getResource("/regexes.yaml");
        File yaml = new File(url.getPath());
        if(yaml.exists()) {
            parser = new Parser();
        } else {
            throw new RuntimeException("Can't find regexes.yaml");
        }
    }

    @Test
    public void testParseUserAgent() throws Exception {
        testUserAgentFromYaml("tests/test_ua.yaml");
    }

    @Test
    public void testParseOS() {
        testOSFromYaml("tests/test_os.yaml");
    }

    @Test
    public void testParseAdditionalOS() {
        testOSFromYaml("test_resources/additional_os_tests.yaml");
    }


    @Test
    public void testParseDevice() {
        testDeviceFromYaml("tests/test_device.yaml");
    }

    @Test
    public void testParseFirefox() {
        testUserAgentFromYaml("test_resources/firefox_user_agent_strings.yaml");
    }

    @Test
    public void testParsePGTS() {
        testUserAgentFromYaml("test_resources/pgts_browser_list.yaml");
    }
